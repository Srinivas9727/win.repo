...
#    file_path = '/Users/stuti/Downloads/Music-Recommendation-using-Emotion-Facial-Recognition-main/data_moods.csv'
#    selected_mood = show_text[0]  # Assuming show_text[0] holds the mood index you want to select
#    df = pd.read_csv(file_path)
#    selected_rows = df[df['mood'] == selected_mood]
#    df = selected_rows[['name', 'album', 'artist']]
#    df = df.head(15)
#    return df
